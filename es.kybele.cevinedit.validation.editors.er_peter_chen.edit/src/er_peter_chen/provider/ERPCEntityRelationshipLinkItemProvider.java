...
/**
 * This is the item provider adapter for a {@link er_peter_chen.ERPCEntityRelationshipLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Er_peter_chenPackage.Literals.ERPC_ENTITY_RELATIONSHIP_LINK__RELATIONSHIP,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Er_peter_chenPackage.Literals.ERPC_ENTITY_RELATIONSHIP_LINK__ENTITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Er_peter_chenPackage.Literals.ERPC_ENTITY_RELATIONSHIP_LINK__CARDINALITY,
				 true,
				 false,
				 false,
