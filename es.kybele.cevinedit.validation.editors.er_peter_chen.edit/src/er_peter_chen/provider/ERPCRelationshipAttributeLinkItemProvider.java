...
/**
 * This is the item provider adapter for a {@link er_peter_chen.ERPCRelationshipAttributeLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Er_peter_chenPackage.Literals.ERPC_RELATIONSHIP_ATTRIBUTE_LINK__RELATIONSHIP,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Er_peter_chenPackage.Literals.ERPC_RELATIONSHIP_ATTRIBUTE_LINK__ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
