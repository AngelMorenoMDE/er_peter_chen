 ...
 * @generated
 */
public class Er_peter_chenSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Er_peter_chenPackage.ERPC_ENTITY_ATTRIBUTE_LINK: {
			...
			case Er_peter_chenPackage.ERPC_RELATIONSHIP_ATTRIBUTE_LINK: {
			...
			case Er_peter_chenPackage.ERPC_IDENTIFYING_RELATIONSHIP: {
			...
			case Er_peter_chenPackage.ERPC_COMPOSITE_ATTRIBUTE: {
			...
			case Er_peter_chenPackage.ERPC_PRIMARY_KEY_ATTRIBUTE: {
			...
			case Er_peter_chenPackage.ERPC_WEAK_KEY_ATTRIBUTE: {
			...
			case Er_peter_chenPackage.ERPC_DERIVED_ATTRIBUTE: {
			...
			case Er_peter_chenPackage.ERPC_MULTI_VALUED_ATTRIBUTE: {
			...
			case Er_peter_chenPackage.ERPC_ENTITY: {
				ERPCEntity erpcEntity = (ERPCEntity)theEObject;
				T result = caseERPCEntity(erpcEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Er_peter_chenPackage.ERPC_REGULAR_ENTITY: {
			...
			case Er_peter_chenPackage.ERPC_WEAK_ENTITY: {
