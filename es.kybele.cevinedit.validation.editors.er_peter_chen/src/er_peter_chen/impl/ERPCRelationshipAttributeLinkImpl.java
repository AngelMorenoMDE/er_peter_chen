 ...
 * <ul>
 *   <li>{@link er_peter_chen.impl.ERPCRelationshipAttributeLinkImpl#getRelationship <em>Relationship</em>}</li>
 *   <li>{@link er_peter_chen.impl.ERPCRelationshipAttributeLinkImpl#getAttribute <em>Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ERPCRelationshipAttributeLinkImpl extends ERPCLinkImpl implements ERPCRelationshipAttributeLink {
	...
	protected EClass eStaticClass() {
		return Er_peter_chenPackage.Literals.ERPC_RELATIONSHIP_ATTRIBUTE_LINK;
	}
		...
		if (relationship != null && relationship.eIsProxy()) {
			...
			if (relationship != oldRelationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Er_peter_chenPackage.ERPC_RELATIONSHIP_ATTRIBUTE_LINK__RELATIONSHIP, oldRelationship, relationship));
			}
		}
		return relationship;
	}
	...
	public void setRelationship(ERPCRelationship newRelationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Er_peter_chenPackage.ERPC_RELATIONSHIP_ATTRIBUTE_LINK__RELATIONSHIP, oldRelationship, relationship));
	}
	...
	public ERPCAttribute getAttribute() {
		if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Er_peter_chenPackage.ERPC_RELATIONSHIP_ATTRIBUTE_LINK__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setAttribute(ERPCAttribute newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Er_peter_chenPackage.ERPC_RELATIONSHIP_ATTRIBUTE_LINK__ATTRIBUTE, oldAttribute, attribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Er_peter_chenPackage.ERPC_RELATIONSHIP_ATTRIBUTE_LINK__RELATIONSHIP:
				if (resolve) return getRelationship();
				return basicGetRelationship();
			case Er_peter_chenPackage.ERPC_RELATIONSHIP_ATTRIBUTE_LINK__ATTRIBUTE:
