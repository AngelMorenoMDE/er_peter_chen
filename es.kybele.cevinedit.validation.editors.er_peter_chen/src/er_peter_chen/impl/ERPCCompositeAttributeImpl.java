 ...
 * <ul>
 *   <li>{@link er_peter_chen.impl.ERPCCompositeAttributeImpl#getComposedAttributes <em>Composed Attributes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ERPCCompositeAttributeImpl extends ERPCAttributeImpl implements ERPCCompositeAttribute {
	...
	protected EClass eStaticClass() {
		return Er_peter_chenPackage.Literals.ERPC_COMPOSITE_ATTRIBUTE;
	}
	...
	public EList<ERPCRegularAttribute> getComposedAttributes() {
		if (composedAttributes == null) {
			composedAttributes = new EObjectResolvingEList<ERPCRegularAttribute>(ERPCRegularAttribute.class, this, Er_peter_chenPackage.ERPC_COMPOSITE_ATTRIBUTE__COMPOSED_ATTRIBUTES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Er_peter_chenPackage.ERPC_COMPOSITE_ATTRIBUTE__COMPOSED_ATTRIBUTES:
