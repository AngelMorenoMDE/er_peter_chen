 ...
 * <ul>
 *   <li>{@link er_peter_chen.impl.ERPCEntityRelationshipLinkImpl#getRelationship <em>Relationship</em>}</li>
 *   <li>{@link er_peter_chen.impl.ERPCEntityRelationshipLinkImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link er_peter_chen.impl.ERPCEntityRelationshipLinkImpl#getCardinality <em>Cardinality</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ERPCEntityRelationshipLinkImpl extends ERPCLinkImpl implements ERPCEntityRelationshipLink {
	...
	protected EClass eStaticClass() {
		return Er_peter_chenPackage.Literals.ERPC_ENTITY_RELATIONSHIP_LINK;
	}
		...
		if (relationship != null && relationship.eIsProxy()) {
			...
			if (relationship != oldRelationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Er_peter_chenPackage.ERPC_ENTITY_RELATIONSHIP_LINK__RELATIONSHIP, oldRelationship, relationship));
			}
		}
		return relationship;
	}
	...
	public void setRelationship(ERPCRelationship newRelationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Er_peter_chenPackage.ERPC_ENTITY_RELATIONSHIP_LINK__RELATIONSHIP, oldRelationship, relationship));
	}
	...
	public ERPCEntity getEntity() {
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Er_peter_chenPackage.ERPC_ENTITY_RELATIONSHIP_LINK__ENTITY, oldEntity, entity));
			}
		}
		return entity;
	}
	...
	public void setEntity(ERPCEntity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Er_peter_chenPackage.ERPC_ENTITY_RELATIONSHIP_LINK__ENTITY, oldEntity, entity));
	}
	...
	public void setCardinality(String newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Er_peter_chenPackage.ERPC_ENTITY_RELATIONSHIP_LINK__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Er_peter_chenPackage.ERPC_ENTITY_RELATIONSHIP_LINK__RELATIONSHIP:
				if (resolve) return getRelationship();
				return basicGetRelationship();
			case Er_peter_chenPackage.ERPC_ENTITY_RELATIONSHIP_LINK__ENTITY:
				if (resolve) return getEntity();
				return basicGetEntity();
			case Er_peter_chenPackage.ERPC_ENTITY_RELATIONSHIP_LINK__CARDINALITY:
