...
import er_peter_chen.ERPCAttribute;
import er_peter_chen.ERPCCompositeAttribute;
import er_peter_chen.ERPCDerivedAttribute;
import er_peter_chen.ERPCDiagram;
import er_peter_chen.ERPCEntity;
import er_peter_chen.ERPCEntityAttributeLink;
import er_peter_chen.ERPCEntityRelationshipLink;
import er_peter_chen.ERPCIdentifyingRelationship;
import er_peter_chen.ERPCLink;
import er_peter_chen.ERPCMultiValuedAttribute;
import er_peter_chen.ERPCPrimaryKeyAttribute;
import er_peter_chen.ERPCRegularAttribute;
import er_peter_chen.ERPCRegularEntity;
import er_peter_chen.ERPCRegularRelationship;
import er_peter_chen.ERPCRelationship;
import er_peter_chen.ERPCRelationshipAttributeLink;
import er_peter_chen.ERPCWeakEntity;
import er_peter_chen.ERPCWeakKeyAttribute;
 ...
 * @generated
 */
public class Er_peter_chenPackageImpl extends EPackageImpl implements Er_peter_chenPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see er_peter_chen.Er_peter_chenPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Er_peter_chenPackageImpl() {
		super(eNS_URI, Er_peter_chenFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Er_peter_chenPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Er_peter_chenPackage init() {
		if (isInited) return (Er_peter_chenPackage)EPackage.Registry.INSTANCE.getEPackage(Er_peter_chenPackage.eNS_URI);

		// Obtain or create and register package
		Er_peter_chenPackageImpl theEr_peter_chenPackage = (Er_peter_chenPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Er_peter_chenPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Er_peter_chenPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theEr_peter_chenPackage.createPackageContents();

		// Initialize created meta-data
		theEr_peter_chenPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEr_peter_chenPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Er_peter_chenPackage.eNS_URI, theEr_peter_chenPackage);
		return theEr_peter_chenPackage;
	}
	 ...
	 * @generated
	 */
	public Er_peter_chenFactory getEr_peter_chenFactory() {
		return (Er_peter_chenFactory)getEFactoryInstance();
	}
