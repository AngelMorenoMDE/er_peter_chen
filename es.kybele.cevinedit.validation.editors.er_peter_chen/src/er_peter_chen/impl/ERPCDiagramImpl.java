 ...
 * <ul>
 *   <li>{@link er_peter_chen.impl.ERPCDiagramImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link er_peter_chen.impl.ERPCDiagramImpl#getRelationships <em>Relationships</em>}</li>
 *   <li>{@link er_peter_chen.impl.ERPCDiagramImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link er_peter_chen.impl.ERPCDiagramImpl#getEntities <em>Entities</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ERPCDiagramImpl extends MinimalEObjectImpl.Container implements ERPCDiagram {
	...
	protected EClass eStaticClass() {
		return Er_peter_chenPackage.Literals.ERPC_DIAGRAM;
	}
	...
	public EList<ERPCLink> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<ERPCLink>(ERPCLink.class, this, Er_peter_chenPackage.ERPC_DIAGRAM__LINKS);
		}
		return links;
	}
	...
	public EList<ERPCRelationship> getRelationships() {
		if (relationships == null) {
			relationships = new EObjectContainmentEList<ERPCRelationship>(ERPCRelationship.class, this, Er_peter_chenPackage.ERPC_DIAGRAM__RELATIONSHIPS);
		}
	...
	public EList<ERPCAttribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<ERPCAttribute>(ERPCAttribute.class, this, Er_peter_chenPackage.ERPC_DIAGRAM__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public EList<ERPCEntity> getEntities() {
		if (entities == null) {
			entities = new EObjectContainmentEList<ERPCEntity>(ERPCEntity.class, this, Er_peter_chenPackage.ERPC_DIAGRAM__ENTITIES);
		}
		return entities;
	}
