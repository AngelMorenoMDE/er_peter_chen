 ...
 * @generated
 */
public class Er_peter_chenModelingAssistantProviderOfERPCIdentifyingRelationshipEditPart
		extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((er_peter_chen.diagram.edit.parts.ERPCIdentifyingRelationshipEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			er_peter_chen.diagram.edit.parts.ERPCIdentifyingRelationshipEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(er_peter_chen.diagram.edit.parts.ERPCIdentifyingRelationshipEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((er_peter_chen.diagram.edit.parts.ERPCIdentifyingRelationshipEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			er_peter_chen.diagram.edit.parts.ERPCIdentifyingRelationshipEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(er_peter_chen.diagram.edit.parts.ERPCIdentifyingRelationshipEditPart) targetEditPart,
				relationshipType);
	}
