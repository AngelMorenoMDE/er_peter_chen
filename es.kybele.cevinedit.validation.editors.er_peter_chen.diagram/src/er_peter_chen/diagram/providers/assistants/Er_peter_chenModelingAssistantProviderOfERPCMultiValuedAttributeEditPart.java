 ...
 * @generated
 */
public class Er_peter_chenModelingAssistantProviderOfERPCMultiValuedAttributeEditPart
		extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((er_peter_chen.diagram.edit.parts.ERPCMultiValuedAttributeEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			er_peter_chen.diagram.edit.parts.ERPCMultiValuedAttributeEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(er_peter_chen.diagram.edit.parts.ERPCMultiValuedAttributeEditPart) targetEditPart,
				relationshipType);
	}
