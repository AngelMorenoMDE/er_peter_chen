 ...
 * @generated
 */
public class Er_peter_chenModelingAssistantProviderOfERPCWeakKeyAttributeEditPart
		extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((er_peter_chen.diagram.edit.parts.ERPCWeakKeyAttributeEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			er_peter_chen.diagram.edit.parts.ERPCWeakKeyAttributeEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(er_peter_chen.diagram.edit.parts.ERPCWeakKeyAttributeEditPart) targetEditPart,
				relationshipType);
	}
