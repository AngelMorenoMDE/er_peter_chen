 ...
 * @generated
 */
public class Er_peter_chenModelingAssistantProviderOfERPCWeakEntityEditPart
		extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((er_peter_chen.diagram.edit.parts.ERPCWeakEntityEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			er_peter_chen.diagram.edit.parts.ERPCWeakEntityEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(er_peter_chen.diagram.edit.parts.ERPCWeakEntityEditPart) sourceEditPart,
				targetEditPart);
	}
