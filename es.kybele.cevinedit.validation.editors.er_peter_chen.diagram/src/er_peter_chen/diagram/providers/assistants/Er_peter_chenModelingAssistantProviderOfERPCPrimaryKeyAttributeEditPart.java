 ...
 * @generated
 */
public class Er_peter_chenModelingAssistantProviderOfERPCPrimaryKeyAttributeEditPart
		extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((er_peter_chen.diagram.edit.parts.ERPCPrimaryKeyAttributeEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			er_peter_chen.diagram.edit.parts.ERPCPrimaryKeyAttributeEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(er_peter_chen.diagram.edit.parts.ERPCPrimaryKeyAttributeEditPart) targetEditPart,
				relationshipType);
	}
