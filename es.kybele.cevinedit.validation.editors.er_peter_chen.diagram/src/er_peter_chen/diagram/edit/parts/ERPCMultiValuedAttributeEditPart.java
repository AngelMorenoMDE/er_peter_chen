...
public class ERPCMultiValuedAttributeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new er_peter_chen.diagram.edit.policies.ERPCMultiValuedAttributeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof er_peter_chen.diagram.edit.parts.ERPCMultiValuedAttributeNameEditPart) {
			((er_peter_chen.diagram.edit.parts.ERPCMultiValuedAttributeNameEditPart) childEditPart)
