...
public class ERPCPrimaryKeyAttributeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new er_peter_chen.diagram.edit.policies.ERPCPrimaryKeyAttributeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof er_peter_chen.diagram.edit.parts.ERPCPrimaryKeyAttributeNameEditPart) {
			((er_peter_chen.diagram.edit.parts.ERPCPrimaryKeyAttributeNameEditPart) childEditPart)
