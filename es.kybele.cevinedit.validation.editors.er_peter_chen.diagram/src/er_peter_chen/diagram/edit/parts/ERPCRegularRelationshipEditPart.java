...
public class ERPCRegularRelationshipEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new er_peter_chen.diagram.edit.policies.ERPCRegularRelationshipItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof er_peter_chen.diagram.edit.parts.ERPCRegularRelationshipNameEditPart) {
			((er_peter_chen.diagram.edit.parts.ERPCRegularRelationshipNameEditPart) childEditPart)
