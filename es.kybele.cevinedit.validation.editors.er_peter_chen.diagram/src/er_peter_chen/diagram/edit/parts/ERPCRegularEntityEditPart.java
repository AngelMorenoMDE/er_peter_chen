...
public class ERPCRegularEntityEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new er_peter_chen.diagram.edit.policies.ERPCRegularEntityItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof er_peter_chen.diagram.edit.parts.ERPCRegularEntityNameEditPart) {
			((er_peter_chen.diagram.edit.parts.ERPCRegularEntityNameEditPart) childEditPart)
