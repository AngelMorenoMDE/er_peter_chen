...
public class ERPCDerivedAttributeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new er_peter_chen.diagram.edit.policies.ERPCDerivedAttributeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof er_peter_chen.diagram.edit.parts.ERPCDerivedAttributeNameEditPart) {
			((er_peter_chen.diagram.edit.parts.ERPCDerivedAttributeNameEditPart) childEditPart)
