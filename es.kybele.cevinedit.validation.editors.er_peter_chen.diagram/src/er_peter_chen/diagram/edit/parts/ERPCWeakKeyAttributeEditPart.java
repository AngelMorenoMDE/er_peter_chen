...
public class ERPCWeakKeyAttributeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new er_peter_chen.diagram.edit.policies.ERPCWeakKeyAttributeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof er_peter_chen.diagram.edit.parts.ERPCWeakKeyAttributeNameEditPart) {
			((er_peter_chen.diagram.edit.parts.ERPCWeakKeyAttributeNameEditPart) childEditPart)
