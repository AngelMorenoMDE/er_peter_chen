 ...
 * @generated
 */
public class ERPCEntityRelationshipLinkCardinalityEditPart extends
	 ...
	 * @generated
	 */
	public ERPCEntityRelationshipLinkCardinalityEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new er_peter_chen.diagram.edit.policies.Er_peter_chenTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = er_peter_chen.diagram.providers.Er_peter_chenParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					er_peter_chen.diagram.edit.parts.Er_peter_chenEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new ERPCEntityRelationshipLinkCardinalityLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ERPCEntityRelationshipLinkCardinalityLabelFigure extends
			WrappingLabel {

		/**
		 * @generated
		 */
		public ERPCEntityRelationshipLinkCardinalityLabelFigure() {
			this.setText("1");
	 ...
	 * @generated
	 */
	static final Font THIS_FONT = new Font(Display.getCurrent(), "Arial", 9,
			SWT.BOLD);
